...
class NewDeviceOrder(object):
    def __init__(self,
        ...
        self.order = ActivateOrder(self.app_api_url,
                                   self.sso_host,
                                   self.aop_client_id,
    ...
    def create_manufacturing(self, part):
        ...
        try:
            self.order = ActivateOrder(self.app_api_url, self.sso_host, self.aop_client_id, self.aop_client_secret)
            res = self.order.postManufacturingOrder(self.app_api_url, payload, self.deviceCategory)
            log.info(res)
            log.info(payload)
            if res['code'] == 201:
    ...
    def create_pos_order(self):
        ...
        try:
            self.order = ActivateOrder(self.app_api_url, self.sso_host, self.aop_client_id, self.aop_client_secret)
            pos_order = self.order.postPointOfSalesOrder(self.app_api_url, pos_order_data, self.deviceCategory)
    ...
    def create_sds_order(self, part):
        ...
        try:
            self.order = ActivateOrder(self.app_api_url, self.sso_host, self.aop_client_id, self.aop_client_secret)
            pos_direct_order = self.order.postSdsOrder(self.app_api_url, sds_order_data, self.deviceCategory)
    ...
    def create_lic_order(self, part):
        ...
        try:
            self.order = ActivateOrder(self.app_api_url, self.sso_host, self.aop_client_id, self.aop_client_secret)
            self.order.postLicOrder(self.app_api_url, lic_order_payload, self.deviceCategory)
            get_lic_order_resp = self.order.getLicOrder(self.app_api_url, self.deviceCategory,
    ...
    def create_part_name(self):
        ...
        try:
            self.order = ActivateOrder(self.app_api_url, self.sso_host, self.aop_client_id, self.aop_client_secret)
            create_part = self.order.createPartName(self.app_api_url, part_data_payload, self.deviceCategory, objkey)
    ...
    def create_platform(self):
        ...
        try:
            self.order = ActivateOrder(self.app_api_url, self.sso_host, self.aop_client_id, self.aop_client_secret)
            create_platform_resp = self.order.createPlatform(self.app_api_url, platform_data_payload)
