...
class UserProfile(BasePage):
    ...
    def update_password(self, user_data: CreateUserData = CreateUserData):
        ...
        self.page.fill(
            UserProfileSelectors.CURRENT_PASSWORD, user_data.current_password
        )
        self.page.fill(UserProfileSelectors.NEW_PASSWORD, user_data.change_password)
        self.page.fill(
            UserProfileSelectors.CONFIRM_NEW_PASSWORD, user_data.confirm_password
        )
    ...
    def update_personal_information(self, user_data: CreateUserData = CreateUserData):
        ...
        self.page.locator(UserProfileSelectors.PRIMARY_PHONE).fill(
            user_data.phone_number
        )
        self.page.locator(UserProfileSelectors.MOBILE_PHONE).fill(
            user_data.phone_number
        )
        self.pw_utils.save_screenshot(self.test_name)
