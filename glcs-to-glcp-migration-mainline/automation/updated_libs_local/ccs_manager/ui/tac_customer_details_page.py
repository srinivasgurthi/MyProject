...
from hpe_glcp_automation_lib.libs.ccs_manager.ui.locators import TacCustomerDetailsSelectors
...
class TacCustomerDetailsPage(HeaderedPage):
    ...
    def wait_for_loaded_table(self):
        ...
        self.page.wait_for_selector(TacCustomerDetailsSelectors.TABLE_ROWS, state="visible", strict=False)
    ...
    def click_tab_link(self, tab_text):
        ...
        self.page.locator(TacCustomerDetailsSelectors.TABS_TEMPLATE.format(tab_text)).click()
        return self
    ...
    def create_new_folder(self, folder_name, parent_folder="default", description=""):
        ...
        self.pw_utils.select_drop_down_element(TacCustomerDetailsSelectors.PARENT_NAME_DROPDOWN,
                                               parent_folder,
                                               "option")
    ...
    def create_new_alias(self, alias_name, alias_type="Customer Name"):
        ...
        self.page.locator(TacCustomerDetailsSelectors.ALIAS_NAME_INPUT_FIELD).fill(alias_name)
        self.pw_utils.select_drop_down_element(TacCustomerDetailsSelectors.ALIAS_TYPE_DROPDOWN,
                                               alias_type,
                                               "option")
    ...
    def delete_alias(self, alias_name):
        ...
        row = self.page.locator(TacCustomerDetailsSelectors.TABLE_ROWS).filter(has_text=alias_name)
        ...
        self.page.wait_for_selector(TacCustomerDetailsSelectors.POPUP_DELETE_BTN).is_hidden()
        return self
    ...
    def search_for_text(self, search_text, ensure_not_empty=True):
        ...
        self.pw_utils.enter_text_into_element(TacCustomerDetailsSelectors.SEARCH_FIELD, search_text)
        if ensure_not_empty:
    ...
    def open_folder_details_page(self, column_name, value):
        ...
        self.page.locator(TacCustomerDetailsSelectors.TABLE_ROW_TEMPLATE.format(matching_rows_indices[0])).click()
    ...
    def move_to_folder(self, folder_name: str):
        ...
        self.pw_utils.select_drop_down_element(drop_menu_selector=TacCustomerDetailsSelectors.FOLDER_NAME_DROPDOWN,
                                               element=folder_name,
                                               element_role="option",
                                               exact_match=True)
    ...
    def select_rows_with_text_in_column(self, column_name, value, required_match=True):
        ...
        :return: current instance of TAC Customer Details page object.
        """
        log.info(f"Playwright: check checkboxes of rows with text '{value}' in column '{column_name}'.")
        matching_rows_indices = self.table_utils.get_rows_indices_by_text_in_column(column_name, value)
        if required_match and not matching_rows_indices:
            raise ValueError(f"Row with expected value '{value}' in column '{column_name}' was not found.")
        for row_index in matching_rows_indices:
            self.page.locator(TacCustomerDetailsSelectors.TABLE_ROW_CHECKBOX_TEMPLATE.format(row_index)).click()
        return self
    ...
    def open_device_details_page(self, column_name, value):
        ...
        if column_name == "Serial Number":
            ...
            sn_column_selector = \
                TacCustomerDetailsSelectors.TABLE_ROW_COLUMN_TEMPLATE.format(row_index=matching_rows_indices[0],
                                                                             column_index=sn_column_index)
    ...
    def get_visible_devices_count_in_folder(self, folder_name):
        ...
        dev_count = int(self.table_utils.get_column_value_from_matched_row({"Name": folder_name}, "Number of Devices"))
        return dev_count
    ...
    def should_have_row_with_text_in_column(self, column_name, value):
        ...
        expect(self.page.locator(
            TacCustomerDetailsSelectors.TABLE_ROW_TEMPLATE.format(matching_rows_indices[0]))).to_be_visible()
        return self
    ...
    def should_have_rows_count(self, count):
        ...
        self.pw_utils.save_screenshot(self.test_name)
        expect(self.page.locator(TacCustomerDetailsSelectors.TABLE_ROWS)).to_have_count(count)
        self.page.wait_for_load_state("domcontentloaded")
        return self
