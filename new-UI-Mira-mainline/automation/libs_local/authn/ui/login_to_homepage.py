...
from hpe_glcp_automation_lib.libs.authn.ui.base import GlcBasePage
...
class Login(object):
    ...
    def login_acct(self, page, account_name=None):
        """Login into account with the name: {account_name}
    ...
    def select_acct(self, page, account_name):
        """
        Select account name with param: {page} and param: {account_name} 
        :param: page: (required)
        :param: account_name: (required)
        :return: None
        """
    ...
    def go_to_home(self, page, login_url, account_name):
        """
        Go to the home Page for arg: {page},arg: {login_url} and arg: account_name
    ...
    def wrong_password(self, page, login_url):
        """
         Fill up the wrong password for arg: {page},arg: {login_url}
    ...
    def wrong_user(self, page, login_url):
        """
        Fill Wrong user arg: {page},arg: {login_url}
        
        :param: page: (required)
        :param: login_url: (required)
        :return: None
        """
        page.goto(login_url, timeout=0)
        log.info(f"Opening :: {login_url}")
...
class GLCAuthnPage(GlcBasePage, LoginPagePaths):
    ...
    def __init__(self, page: Page) -> None:
        """ 
        Initialize object with page {page}
    ...
    def login(
        ...
        """
        Login into GLC arg: {username},arg: {password}
