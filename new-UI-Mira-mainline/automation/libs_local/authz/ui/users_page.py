...
class Users(HeaderedPage):
    ...
    def wait_for_loaded_table(self):
        ...
        self.page.wait_for_selector(UsersSelectors.TABLE_ROWS, state="visible", strict=False)
    ...
    def search_for_text(self, search_text):
        ...
        self.pw_utils.enter_text_into_element(
            UsersSelectors.SEARCH_FIELD, search_text)
    ...
    def should_contain_text_in_table(self, text):
        ...
        """
        log.info(
            f"Playwright: check that row with text '{text}' is present in table.")
        self.pw_utils.save_screenshot(self.test_name)
        expect(self.page.locator(UsersSelectors.TABLE_ROWS,
    ...
    def should_have_row_with_text_in_column(self, column_name, value):
        ...
        expect(self.page.locator(UsersSelectors.TABLE_ROW_TEMPLATE.format(matching_rows_indices[0]))).to_be_visible()
    ...
    def should_contain_text_in_title(self, text):
        ...
        """
        log.info(
            f"Playwright: check that title contains text '{text}' in users page.")
        self.pw_utils.save_screenshot(self.test_name)
        expect(self.page.locator(UsersSelectors.HEADING_PAGE_TITLE)
    ...
    def should_have_text_in_title(self, text):
        ...
        """
        log.info(
            f"Playwright: check that title has matched text '{text}' in users page.")
        self.pw_utils.save_screenshot(self.test_name)
        expect(self.page.locator(UsersSelectors.HEADING_PAGE_TITLE)
               ).to_have_text(text)
        return self
    ...
    def invite_user(self, user_email, role: str = 'Observer'):
        ...
        self.page.locator(
            UsersSelectors.INVITE_USERS_EMAIL_FIELD).fill(user_email)
        self.page.locator(
            UsersSelectors.INVITE_USERS_ROLES_DROPDOWN).click()
        self.page.locator(
            UsersSelectors.INVITE_USERS_ROLE_TEMPLATE.format(role)).click()
        self.pw_utils.save_screenshot(self.test_name)
        self.page.locator(
            UsersSelectors.INVITE_USERS_SEND_INVITE_BTN).click()
        self.wait_for_loaded_state()
        return self
    ...
    def delete_user(self, user_email):
        ...
        """
        self.search_for_text(user_email)
        self.page.locator(UsersSelectors.TABLE_ACTION_BTN_TEMPLATE.format(user_email)).click()
