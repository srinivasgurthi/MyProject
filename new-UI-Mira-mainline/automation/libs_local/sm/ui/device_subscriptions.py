...
class DeviceSubscriptions(HeaderedPage):
    ...
    def search_for_text(self, search_text):
        ...
        self.pw_utils.enter_text_into_element(DevSubscriptionsSelectors.SEARCH_FIELD, search_text)
    ...
    def should_have_search_field(self):
        ...
        expect(search_field_locator).to_have_attribute("placeholder", "Search Subscription Keys")
        return self
    ...
    def should_have_row_with_text_in_column(self, column_name, value):
        ...
        expect(self.page.locator(
            DevSubscriptionsSelectors.TABLE_ROW_TEMPLATE.format(matching_rows_indices[0]))).to_be_visible()
        return self
    ...
    def should_have_rows_count(self, count):
        ...
        expect(self.page.locator(DevSubscriptionsSelectors.TABLE_ROWS)).to_have_count(count)
        self.page.wait_for_load_state("domcontentloaded")
        return self
